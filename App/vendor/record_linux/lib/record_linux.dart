...
class RecordLinux extends RecordPlatform {
  ...
  // Vendored stub: this app never builds/runs on Linux, but Flutter's plugin
  // registrant imports record_linux unconditionally, so it must satisfy the
  // record_platform_interface 1.6.0 API (which added startStream).
  @override
