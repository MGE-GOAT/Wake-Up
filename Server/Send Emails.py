...
# Login with your email and password (read from env — never hardcode secrets).
smtp.login(
    os.environ.get('SMTP_SENDER_EMAIL', 'noorijustfortest1@gmail.com'),
    os.environ.get('SMTP_SENDER_PASSWORD', ''),
)
